...
var browsers = _.filter(BROWSERS, function(browser) {
  if (browser.browserName === 'internet explorer' && browser.version === '8') {
    return false;
  }
  return true;
});
...
module.exports = function(grunt) {
  ...
  function getSemverURLPath() {
    return ASSET_HOST + '/widgets/rich-text-editor/v' + getSemver();
  }
  ...
  grunt.registerTask('component:build:prod', function() {
    ...
    var exportName = '"];' +
      ...
      'this.goinstant.widgets["RichTextEditor';
