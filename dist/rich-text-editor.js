...
require.register("rich-text-editor/index.js", function(exports, require, module){
/*jshint browser:true*/
/*global module, require*/
'use strict';

module.exports = require('./lib/rich_text_editor');

});
require.register("rich-text-editor/lib/rich_text_editor.js", function(exports, require, module){
/*jshint browser:true*/
/*global module, require*/
'use strict';
...
var DEFAULT_OT_NAME = 'rich-text-document';
...
function RichTextEditor(opts) {
  ...
  if (opts.otName && !_.isString(opts.otName)) {
    throw new Error('Invalid otName included in options passed to quill widget.');
  }
  ...
  this._otName = opts.otName || DEFAULT_OT_NAME;
...
RichTextEditor.prototype._initSync = function() {
  ...
  var ot = this._room.ot(this._otName, function(err, delta, context) {
...
require.register("rich-text-editor/vendor/quill.js", function(exports, require, module){
...
require.register("rich-text-editor/templates/align.html", function(exports, require, module){
module.exports = '<select title="Text Alignment" class="sc-align">\n  <option value="left" selected></option>\n  <option value="center"></option>\n  <option value="right"></option>\n  <option value="justify"></option>\n</select>';
});
require.register("rich-text-editor/templates/background.html", function(exports, require, module){
module.exports = '<select title="Background Color" class="sc-background">\n  <option value="rgb(0, 0, 0)"></option>\n  <option value="rgb(230, 0, 0)"></option>\n  <option value="rgb(255, 153, 0)"></option>\n  <option value="rgb(255, 255, 0)"></option>\n  <option value="rgb(0, 138, 0)"></option>\n  <option value="rgb(0, 102, 204)"></option>\n  <option value="rgb(153, 51, 255)"></option>\n  <option value="rgb(255, 255, 255)" selected></option>\n  <option value="rgb(250, 204, 204)"></option>\n  <option value="rgb(255, 235, 204)"></option>\n  <option value="rgb(255, 255, 204)"></option>\n  <option value="rgb(204, 232, 204)"></option>\n  <option value="rgb(204, 224, 245)"></option>\n  <option value="rgb(235, 214, 255)"></option>\n  <option value="rgb(187, 187, 187)"></option>\n  <option value="rgb(240, 102, 102)"></option>\n  <option value="rgb(255, 194, 102)"></option>\n  <option value="rgb(255, 255, 102)"></option>\n  <option value="rgb(102, 185, 102)"></option>\n  <option value="rgb(102, 163, 224)"></option>\n  <option value="rgb(194, 133, 255)"></option>\n  <option value="rgb(136, 136, 136)"></option>\n  <option value="rgb(161, 0, 0)"></option>\n  <option value="rgb(178, 107, 0)"></option>\n  <option value="rgb(178, 178, 0)"></option>\n  <option value="rgb(0, 97, 0)"></option>\n  <option value="rgb(0, 71, 178)"></option>\n  <option value="rgb(107, 36, 178)"></option>\n  <option value="rgb(68, 68, 68)"></option>\n  <option value="rgb(92, 0, 0)"></option>\n  <option value="rgb(102, 61, 0)"></option>\n  <option value="rgb(102, 102, 0)"></option>\n  <option value="rgb(0, 55, 0)"></option>\n  <option value="rgb(0, 41, 102)"></option>\n  <option value="rgb(61, 20, 102)"></option>\n</select>';
});
require.register("rich-text-editor/templates/bold.html", function(exports, require, module){
module.exports = '<span title="Bold" class="sc-format-button sc-bold"></span>';
});
require.register("rich-text-editor/templates/color.html", function(exports, require, module){
module.exports = '<select title="Text Color" class="sc-color">\n  <option value="rgb(0, 0, 0)" selected></option>\n  <option value="rgb(230, 0, 0)"></option>\n  <option value="rgb(255, 153, 0)"></option>\n  <option value="rgb(255, 255, 0)"></option>\n  <option value="rgb(0, 138, 0)"></option>\n  <option value="rgb(0, 102, 204)"></option>\n  <option value="rgb(153, 51, 255)"></option>\n  <option value="rgb(255, 255, 255)"></option>\n  <option value="rgb(250, 204, 204)"></option>\n  <option value="rgb(255, 235, 204)"></option>\n  <option value="rgb(255, 255, 204)"></option>\n  <option value="rgb(204, 232, 204)"></option>\n  <option value="rgb(204, 224, 245)"></option>\n  <option value="rgb(235, 214, 255)"></option>\n  <option value="rgb(187, 187, 187)"></option>\n  <option value="rgb(240, 102, 102)"></option>\n  <option value="rgb(255, 194, 102)"></option>\n  <option value="rgb(255, 255, 102)"></option>\n  <option value="rgb(102, 185, 102)"></option>\n  <option value="rgb(102, 163, 224)"></option>\n  <option value="rgb(194, 133, 255)"></option>\n  <option value="rgb(136, 136, 136)"></option>\n  <option value="rgb(161, 0, 0)"></option>\n  <option value="rgb(178, 107, 0)"></option>\n  <option value="rgb(178, 178, 0)"></option>\n  <option value="rgb(0, 97, 0)"></option>\n  <option value="rgb(0, 71, 178)"></option>\n  <option value="rgb(107, 36, 178)"></option>\n  <option value="rgb(68, 68, 68)"></option>\n  <option value="rgb(92, 0, 0)"></option>\n  <option value="rgb(102, 61, 0)"></option>\n  <option value="rgb(102, 102, 0)"></option>\n  <option value="rgb(0, 55, 0)"></option>\n  <option value="rgb(0, 41, 102)"></option>\n  <option value="rgb(61, 20, 102)"></option>\n</select>';
});
require.register("rich-text-editor/templates/font.html", function(exports, require, module){
module.exports = '<select title="Font" class="sc-font">\n  <option value="sans-serif" selected>Sans Serif</option>\n  <option value="serif">Serif</option>\n  <option value="monospace">Monospace</option>\n</select>';
});
require.register("rich-text-editor/templates/image.html", function(exports, require, module){
module.exports = '<span title="Image" class="sc-format-button sc-image"></span>';
});
require.register("rich-text-editor/templates/italic.html", function(exports, require, module){
module.exports = '<span title="Italic" class="sc-format-button sc-italic"></span>';
});
require.register("rich-text-editor/templates/link.html", function(exports, require, module){
module.exports = '<span title="Link" class="sc-format-button sc-link"></span>';
});
require.register("rich-text-editor/templates/size.html", function(exports, require, module){
module.exports = '<select title="Size" class="sc-size">\n  <option value="10px">Small</option>\n  <option value="13px" selected>Normal</option>\n  <option value="18px">Large</option>\n  <option value="32px">Huge</option>\n</select>';
});
require.register("rich-text-editor/templates/strike.html", function(exports, require, module){
module.exports = '<span title="Strikethrough" class="sc-format-button sc-strike"></span>';
});
require.register("rich-text-editor/templates/underline.html", function(exports, require, module){
module.exports = '<span title="Underline" class="sc-format-button sc-underline"></span>';
});
require.alias("component-classes/index.js", "rich-text-editor/deps/classes/index.js");
require.alias("component-classes/index.js", "classes/index.js");
require.alias("component-indexof/index.js", "component-classes/deps/indexof/index.js");

require.alias("lodash-lodash/index.js", "rich-text-editor/deps/lodash/index.js");
require.alias("lodash-lodash/dist/lodash.compat.js", "rich-text-editor/deps/lodash/dist/lodash.compat.js");
require.alias("lodash-lodash/index.js", "lodash/index.js");

require.alias("goinstant-usercache/usercache.js", "rich-text-editor/deps/usercache/usercache.js");
require.alias("goinstant-usercache/usercache.js", "rich-text-editor/deps/usercache/index.js");
...
require.alias("rich-text-editor/index.js", "rich-text-editor/index.js");if (typeof exports == "object") {
  module.exports = require("rich-text-editor");
} else if (typeof define == "function" && define.amd) {
  define([], function(){ return require("rich-text-editor"); });
} else {
  this[""];this.goinstant = this.goinstant || {};this.goinstant.widgets = this.goinstant.widgets || {};this.goinstant.widgets["RichTextEditor"] = require("rich-text-editor");
}})();